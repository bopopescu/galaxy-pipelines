...
_magic_number = 6
_modified_time = 1384057872.291959
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7ff6cc397510', context._clean_inheritance_tokens(), templateuri=u'/user/info.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7ff6cc397510')] = ns

    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0x7ff6cc397e10', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7ff6cc397510')._populate(_import_ns, [u'render_user_info'])
        _mako_get_namespace(context, '__anon_0x7ff6cc397e10')._populate(_import_ns, [u'render_msg'])
