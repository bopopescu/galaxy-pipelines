...
_magic_number = 6
_modified_time = 1382666408.019388
...
def _mako_generate_namespaces(context):
    # SOURCE LINE 3
    ns = runtime.TemplateNamespace('__anon_0x7fa8902b74d0', context._clean_inheritance_tokens(), templateuri=u'/refresh_frames.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7fa8902b74d0')] = ns

    # SOURCE LINE 175
    ns = runtime.TemplateNamespace('__anon_0x7fa8d8034610', context._clean_inheritance_tokens(), templateuri=u'/dataset/security_common.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7fa8d8034610')] = ns

    # SOURCE LINE 2
    ns = runtime.TemplateNamespace('__anon_0x7fa8902b2950', context._clean_inheritance_tokens(), templateuri=u'/message.mako', callables=None, calling_uri=_template_uri)
    context.namespaces[(__name__, '__anon_0x7fa8902b2950')] = ns
...
def render_body(context,**pageargs):
    ...
    try:
        ...
        _import_ns = {}
        _mako_get_namespace(context, '__anon_0x7fa8902b74d0')._populate(_import_ns, [u'handle_refresh_frames'])
        _mako_get_namespace(context, '__anon_0x7fa8d8034610')._populate(_import_ns, [u'render_permission_form'])
        _mako_get_namespace(context, '__anon_0x7fa8902b2950')._populate(_import_ns, [u'render_msg'])
